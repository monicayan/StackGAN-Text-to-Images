...
import sys
sys.path.insert(0, '/home/tt2665/StackGAN')

import prettytensor as pt
import tensorflow as tf
import numpy as np
import scipy.misc, os, argparse, torchfile, re
...
# samplw a encoded vector as input to the generator
...
def build_model(sess, embedding_dim, batch_size):
    model = CondGAN(lr_imsize=cfg.TEST.LR_IMSIZE,
...
def drawCaption(img, caption):
    ...
    # get a font
    fnt = ImageFont.truetype('/usr/share/fonts/Raleway-Regular.ttf', 50)
