...
class CondGANTrainer(object):
    ...
    def build_placeholder(self):
        ...
        self.wrong_images = tf.placeholder(tf.float32, [self.batch_size] + self.dataset.image_shape, name='wrong_images')
    ...
    def init_opt(self):
        ...
        with pt.defaults_scope(phase=pt.Phase.train):
            ...
            discriminator_loss, generator_loss =\
                self.compute_losses(self.images, self.wrong_images, fake_images, self.embeddings)
